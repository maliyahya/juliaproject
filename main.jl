...
println("Learning Series Details:")
for series_detail in learning_series_details
    println(series_detail)
end
...
println("*******")
println(learning_series_details[1])
println("*******")
println("*******")
println(test_series_details[1])
println("*******")
